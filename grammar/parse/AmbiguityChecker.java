...
public class AmbiguityChecker extends BruteParser {
    /**
     * This does nothing. One can use this constructor if one wants to call init
     * later.
     */
    protected AmbiguityChecker() {
    }
     ...
     */
    public AmbiguityChecker(Grammar grammar, String target) {
        init(grammar, target);
    }
     ...
     *            the target string
     */
    public static AmbiguityChecker get(Grammar grammar, String target) {

            return new AmbiguityChecker(grammar, target);
    ...
    private synchronized void parse() {
        ...
        System.out.println("Consider "+node.getDerivation());
        ...
        while (it.hasNext()) {
            ...
            System.out.println("Possiblility "+pNode.getDerivation());
            if (!alreadyAdded.add(pNode.getDerivation())) {
                System.out.println("Added "+pNode.getDerivation());
    ...
    /** This holds the list of nodes for the second parse. */
    protected LinkedList queue1 = new LinkedList();
    ...
    private ParseNode answer1 = null;
    /**
